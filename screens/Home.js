...
const Home = ({navigation}) => {
  ...
  function onSelectCategoty(category) {
    let restaurantList = restaurantData.filter((elem) =>
      elem.categories.includes(category.id),
    );
  ...
  function getcategoryById(id) {
    let category = categories.filter((e) => e.id == id);
  ...
  function renderRestaurantList() {
    const renderItem = ({item}) => (
      <TouchableOpacity
        ...
        //   onPress --> Navigete to Restaurant Screen
        onPress={() =>
